 ...
 */var Kn=Symbol.for("react.element"),uc=Symbol.for("react.portal"),cc=Symbol.for("react.fragment"),dc=Symbol.for("react.strict_mode"),fc=Symbol.for("react.profiler"),pc=Symbol.for("react.provider"),mc=Symbol.for("react.context"),hc=Symbol.for("react.forward_ref"),gc=Symbol.for("react.suspense"),vc=Symbol.for("react.memo"),yc=Symbol.for("react.lazy"),Fi=Symbol.iterator;function Sc(e){return e===null||typeof e!="object"?null:(e=Fi&&e[Fi]||e["@@iterator"],typeof e=="function"?e:null)}var Ks={isMounted:function(){return!1},enqueueForceUpdate:function(){},enqueueReplaceState:function(){},enqueueSetState:function(){}},Xs=Object.assign,Ys={};function ln(e,t,n){this.props=e,this.context=t,this.refs=Ys,this.updater=n||Ks}ln.prototype.isReactComponent={};ln.prototype.setState=function(e,t){if(typeof e!="object"&&typeof e!="function"&&e!=null)throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");this.updater.enqueueSetState(this,e,t,"setState")};ln.prototype.forceUpdate=function(e){this.updater.enqueueForceUpdate(this,e,"forceUpdate")};function qs(){}qs.prototype=ln.prototype;function Wl(e,t,n){this.props=e,this.context=t,this.refs=Ys,this.updater=n||Ks}var Vl=Wl.prototype=new qs;Vl.constructor=Wl;Xs(Vl,ln.prototype);Vl.isPureReactComponent=!0;var zi=Array.isArray,Zs=Object.prototype.hasOwnProperty,Bl={current:null},ea={key:!0,ref:!0,__self:!0,__source:!0};function ta(e,t,n){var r,o={},l=null,i=null;if(t!=null)for(r in t.ref!==void 0&&(i=t.ref),t.key!==void 0&&(l=""+t.key),t)Zs.call(t,r)&&!ea.hasOwnProperty(r)&&(o[r]=t[r]);var s=arguments.length-2;if(s===1)o.children=n;else if(1<s){for(var a=Array(s),c=0;c<s;c++)a[c]=arguments[c+2];o.children=a}if(e&&e.defaultProps)for(r in s=e.defaultProps,s)o[r]===void 0&&(o[r]=s[r]);return{$$typeof:Kn,type:e,key:l,ref:i,props:o,_owner:Bl.current}}function wc(e,t){return{$$typeof:Kn,type:e.type,key:t,ref:e.ref,props:e.props,_owner:e._owner}}function Jl(e){return typeof e=="object"&&e!==null&&e.$$typeof===Kn}function kc(e){var t={"=":"=0",":":"=2"};return"$"+e.replace(/[=:]/g,function(n){return t[n]})}var bi=/\/+/g;function Co(e,t){return typeof e=="object"&&e!==null&&e.key!=null?kc(""+e.key):t.toString(36)}function Sr(e,t,n,r,o){var l=typeof e;(l==="undefined"||l==="boolean")&&(e=null);var i=!1;if(e===null)i=!0;else switch(l){case"string":case"number":i=!0;break;case"object":switch(e.$$typeof){case Kn:case uc:i=!0}}if(i)return i=e,o=o(i),e=r===""?"."+Co(i,0):r,zi(o)?(n="",e!=null&&(n=e.replace(bi,"$&/")+"/"),Sr(o,t,n,"",function(c){return c})):o!=null&&(Jl(o)&&(o=wc(o,n+(!o.key||i&&i.key===o.key?"":(""+o.key).replace(bi,"$&/")+"/")+e)),t.push(o)),1;if(i=0,r=r===""?".":r+":",zi(e))for(var s=0;s<e.length;s++){l=e[s];var a=r+Co(l,s);i+=Sr(l,t,n,a,o)}else if(a=Sc(e),typeof a=="function")for(e=a.call(e),s=0;!(l=e.next()).done;)l=l.value,a=r+Co(l,s++),i+=Sr(l,t,n,a,o);else if(l==="object")throw t=String(e),Error("Objects are not valid as a React child (found: "+(t==="[object Object]"?"object with keys {"+Object.keys(e).join(", ")+"}":t)+"). If you meant to render a collection of children, use an array instead.");return i}function nr(e,t,n){if(e==null)return e;var r=[],o=0;return Sr(e,r,"","",function(l){return t.call(n,l,o++)}),r}function Cc(e){if(e._status===-1){var t=e._result;t=t(),t.then(function(n){(e._status===0||e._status===-1)&&(e._status=1,e._result=n)},function(n){(e._status===0||e._status===-1)&&(e._status=2,e._result=n)}),e._status===-1&&(e._status=0,e._result=t)}if(e._status===1)return e._result.default;throw e._result}var ae={current:null},wr={transition:null},xc={ReactCurrentDispatcher:ae,ReactCurrentBatchConfig:wr,ReactCurrentOwner:Bl};function na(){throw Error("act(...) is not supported in production builds of React.")}N.Children={map:nr,forEach:function(e,t,n){nr(e,function(){t.apply(this,arguments)},n)},count:function(e){var t=0;return nr(e,function(){t++}),t},toArray:function(e){return nr(e,function(t){return t})||[]},only:function(e){if(!Jl(e))throw Error("React.Children.only expected to receive a single React element child.");return e}};N.Component=ln;N.Fragment=cc;N.Profiler=fc;N.PureComponent=Wl;N.StrictMode=dc;N.Suspense=gc;N.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED=xc;N.act=na;N.cloneElement=function(e,t,n){if(e==null)throw Error("React.cloneElement(...): The argument must be a React element, but you passed "+e+".");var r=Xs({},e.props),o=e.key,l=e.ref,i=e._owner;if(t!=null){if(t.ref!==void 0&&(l=t.ref,i=Bl.current),t.key!==void 0&&(o=""+t.key),e.type&&e.type.defaultProps)var s=e.type.defaultProps;for(a in t)Zs.call(t,a)&&!ea.hasOwnProperty(a)&&(r[a]=t[a]===void 0&&s!==void 0?s[a]:t[a])}var a=arguments.length-2;if(a===1)r.children=n;else if(1<a){s=Array(a);for(var c=0;c<a;c++)s[c]=arguments[c+2];r.children=s}return{$$typeof:Kn,type:e.type,key:o,ref:l,props:r,_owner:i}};N.createContext=function(e){return e={$$typeof:mc,_currentValue:e,_currentValue2:e,_threadCount:0,Provider:null,Consumer:null,_defaultValue:null,_globalName:null},e.Provider={$$typeof:pc,_context:e},e.Consumer=e};N.createElement=ta;N.createFactory=function(e){var t=ta.bind(null,e);return t.type=e,t};N.createRef=function(){return{current:null}};N.forwardRef=function(e){return{$$typeof:hc,render:e}};N.isValidElement=Jl;N.lazy=function(e){return{$$typeof:yc,_payload:{_status:-1,_result:e},_init:Cc}};N.memo=function(e,t){return{$$typeof:vc,type:e,compare:t===void 0?null:t}};N.startTransition=function(e){var t=wr.transition;wr.transition={};try{e()}finally{wr.transition=t}};N.unstable_act=na;N.useCallback=function(e,t){return ae.current.useCallback(e,t)};N.useContext=function(e){return ae.current.useContext(e)};N.useDebugValue=function(){};N.useDeferredValue=function(e){return ae.current.useDeferredValue(e)};N.useEffect=function(e,t){return ae.current.useEffect(e,t)};N.useId=function(){return ae.current.useId()};N.useImperativeHandle=function(e,t,n){return ae.current.useImperativeHandle(e,t,n)};N.useInsertionEffect=function(e,t){return ae.current.useInsertionEffect(e,t)};N.useLayoutEffect=function(e,t){return ae.current.useLayoutEffect(e,t)};N.useMemo=function(e,t){return ae.current.useMemo(e,t)};N.useReducer=function(e,t,n){return ae.current.useReducer(e,t,n)};N.useRef=function(e){return ae.current.useRef(e)};N.useState=function(e){return ae.current.useState(e)};N.useSyncExternalStore=function(e,t,n){return ae.current.useSyncExternalStore(e,t,n)};N.useTransition=function(){return ae.current.useTransition()};N.version="18.3.1";Qs.exports=N;var Y=Qs.exports;const Tc=ac(Y);/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(T,R){var M=T.length;T.push(R);e:for(;0<M;){var B=M-1>>>1,K=T[B];if(0<o(K,R))T[B]=R,T[M]=K,M=B;else break e}}function n(T){return T.length===0?null:T[0]}function r(T){if(T.length===0)return null;var R=T[0],M=T.pop();if(M!==R){T[0]=M;e:for(var B=0,K=T.length,er=K>>>1;B<er;){var vt=2*(B+1)-1,ko=T[vt],yt=vt+1,tr=T[yt];if(0>o(ko,M))yt<K&&0>o(tr,ko)?(T[B]=tr,T[yt]=M,B=yt):(T[B]=ko,T[vt]=M,B=vt);else if(yt<K&&0>o(tr,M))T[B]=tr,T[yt]=M,B=yt;else break e}}return R}function o(T,R){var M=T.sortIndex-R.sortIndex;return M!==0?M:T.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var l=performance;e.unstable_now=function(){return l.now()}}else{var i=Date,s=i.now();e.unstable_now=function(){return i.now()-s}}var a=[],c=[],f=1,h=null,g=3,S=!1,w=!1,k=!1,I=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,u=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(T){for(var R=n(c);R!==null;){if(R.callback===null)r(c);else if(R.startTime<=T)r(c),R.sortIndex=R.expirationTime,t(a,R);else break;R=n(c)}}function v(T){if(k=!1,p(T),!w)if(n(a)!==null)w=!0,So(x);else{var R=n(c);R!==null&&wo(v,R.startTime-T)}}function x(T,R){w=!1,k&&(k=!1,d(j),j=-1),S=!0;var M=g;try{for(p(R),h=n(a);h!==null&&(!(h.expirationTime>R)||T&&!je());){var B=h.callback;if(typeof B=="function"){h.callback=null,g=h.priorityLevel;var K=B(h.expirationTime<=R);R=e.unstable_now(),typeof K=="function"?h.callback=K:h===n(a)&&r(a),p(R)}else r(a);h=n(a)}if(h!==null)var er=!0;else{var vt=n(c);vt!==null&&wo(v,vt.startTime-R),er=!1}return er}finally{h=null,g=M,S=!1}}var E=!1,P=null,j=-1,V=5,L=-1;function je(){return!(e.unstable_now()-L<V)}function un(){if(P!==null){var T=e.unstable_now();L=T;var R=!0;try{R=P(!0,T)}finally{R?cn():(E=!1,P=null)}}else E=!1}var cn;if(typeof u=="function")cn=function(){u(un)};else if(typeof MessageChannel<"u"){var _i=new MessageChannel,sc=_i.port2;_i.port1.onmessage=un,cn=function(){sc.postMessage(null)}}else cn=function(){I(un,0)};function So(T){P=T,E||(E=!0,cn())}function wo(T,R){j=I(function(){T(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(T){T.callback=null},e.unstable_continueExecution=function(){w||S||(w=!0,So(x))},e.unstable_forceFrameRate=function(T){0>T||125<T?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):V=0<T?Math.floor(1e3/T):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(a)},e.unstable_next=function(T){switch(g){case 1:case 2:case 3:var R=3;break;default:R=g}var M=g;g=R;try{return T()}finally{g=M}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(T,R){switch(T){case 1:case 2:case 3:case 4:case 5:break;default:T=3}var M=g;g=T;try{return R()}finally{g=M}},e.unstable_scheduleCallback=function(T,R,M){var B=e.unstable_now();switch(typeof M=="object"&&M!==null?(M=M.delay,M=typeof M=="number"&&0<M?B+M:B):M=B,T){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=M+K,T={id:f++,callback:R,priorityLevel:T,startTime:M,expirationTime:K,sortIndex:-1},M>B?(T.sortIndex=M,t(c,T),n(a)===null&&T===n(c)&&(k?(d(j),j=-1):k=!0,wo(v,M-B))):(T.sortIndex=K,t(a,T),w||S||(w=!0,So(x))),T},e.unstable_shouldYield=je,e.unstable_wrapCallback=function(T){var R=g;return function(){var M=g;g=R;try{return T.apply(this,arguments)}finally{g=M}}}})(ia);la.exports=ia;var Lc=la.exports;/**
 * @license React
...
class Container {
  ...
  bind(name, factory) { this.bindings.set(name, factory); }

  make(name) {
    return this.bindings.get(name)(this); // фабрика может запросить другие зависимости
  }
}

const c = new Container();
c.bind('db', () => new Database('localhost'));
...
\`\`\`
Правило: **High Cohesion + Low Coupling** = хорошая архитектура.`},{name:"MVC, MVVM",level:"4",content:`**MVC (Model-View-Controller):**
Три слоя:
• **Model** — данные и бизнес-логика
• **View** — отображение (UI)
• **Controller** — связывает Model и View, обрабатывает действия пользователя

Поток данных: Пользователь → Controller → Model → View → Пользователь
\`\`\`js
// Model — данные:
class UserModel {
...
class UserController {
  ...
  update() {
    document.body.innerHTML = this.view.render(this.model.getUsers());
  }
}
\`\`\`

**MVVM (Model-View-ViewModel):**
• **Model** — данные и бизнес-логика (API, БД, сервисы)
• **View** — UI, декларативный, сам ничего не знает о данных — только отображает то что говорит ViewModel
• **ViewModel** — посредник между Model и View. Хранит состояние для отображения, содержит логику UI, предоставляет команды (методы)

Ключевая идея — **data binding (привязка данных):** View и ViewModel синхронизированы автоматически без ручного обновления DOM.

**Одностороннее связывание** — Model → View (только чтение):
\`\`\`html
<!-- Vue: значение из VM отображается в UI -->
<p>{{ userName }}</p>
<!-- изменился vm.userName → абзац обновился сам -->
\`\`\`

**Двустороннее связывание** — View ↔ ViewModel (чтение + запись):
\`\`\`html
<!-- Vue v-model: поле ввода ↔ vm.name -->
<input v-model="name" />
<!-- пользователь печатает → vm.name обновляется -->
<!-- vm.name меняется в коде → поле обновляется -->
\`\`\`
\`\`\`js
// Под капотом v-model — это сокращение для:
<input :value="name" @input="name = $event.target.value" />
\`\`\`

**Полный пример MVVM на Vue 3:**
\`\`\`js
// Model — чистая бизнес-логика:
const userService = {
  async fetchUsers() { return await api.get('/users'); }
};

// ViewModel — состояние + команды для View:
// (в Vue 3 это setup() или Composition API)
const useUsersVM = () => {
  const users = ref([]);          // состояние для отображения
  const isLoading = ref(false);
  const searchQuery = ref('');

  // вычисляемое свойство — автоматически пересчитывается
  const filtered = computed(() =>
    users.value.filter(u => u.name.includes(searchQuery.value))
  );

  async function load() {         // команда
...
// View — шаблон подписан на ViewModel, ничего не знает о fetchUsers:
// <input v-model="searchQuery" />
// <div v-if="isLoading">Загрузка...</div>
// <li v-for="u in filtered">{{ u.name }}</li>
\`\`\`

**Зачем ViewModel вместо прямого обращения из View к Model:**
View не должен знать откуда берутся данные — это делает его переиспользуемым и тестируемым. ViewModel можно протестировать без рендеринга UI (просто вызвать методы и проверить состояние).

**В React:** однонаправленный поток данных, не чистый MVC/MVVM.
Component = View + часть ViewModel. State/Redux = Model. Controller неявный — обработчики событий внутри компонента.
\`\`\`
MVC/MVVM: View ↔ ViewModel (двустороннее)
React:     Model → View (однонаправленное), события идут через setState/dispatch
\`\`\`

**Ключевое отличие:** в MVC Controller решает что делать с входящим действием и дёргает Model. В MVVM ViewModel реактивно отражает состояние — View биндится к нему напрямую без посредника.`}]},{id:"css",title:"ВЁРСТКА",icon:"🎨",color:"#E44D26",topics:[{name:"Блочная модель",level:"1",content:`Content → Padding → Border → Margin
...
Кейсы: срочный hotfix без прерывания текущей работы, сравнение двух веток бок о бок, запуск тестов на одной ветке пока работаешь на другой.`}]}],Ye=[...Ff,...zf],bf=[];Ye.forEach(e=>{e.topics.forEach(t=>{t.content&&bf.push({section:e.title,sectionColor:e.color,topic:t.name,level:t.level,content:t.content,score:t.score??null})})});function Uf(e){const t=new Set,n=[];return e.forEach(r=>{r.topics.forEach(o=>{if(!o.content)return;const l=/\*\*([^*\n`]+?)\*\*/g;let i;for(;(i=l.exec(o.content))!==null;){const s=i[1].trim();if(s.endsWith(".")||s.endsWith("!")||s.endsWith("?")||/^\d/.test(s)||s.split(/\s+/).length>7||s.length<2)continue;const a=s.toLowerCase();if(t.has(a))continue;t.add(a);const f=o.content.slice(i.index+i[0].length).match(/^[ \t]*[—:][ \t]*([^\n]{5,120})/);let h=f?f[1].replace(/\*\*([^*]+)\*\*/g,"$1").split(/[.!?]/)[0].trim():"";h.endsWith(",")&&(h=h.slice(0,-1)),n.push({name:s,definition:h,sectionId:r.id,sectionTitle:r.title,sectionColor:r.color,sectionIcon:r.icon,topicName:o.name})}})}),n.sort((r,o)=>r.name.localeCompare(o.name,"ru"))}function Hl(e,t){if(!t)return e;const n=e.toLowerCase().indexOf(t.toLowerCase());return n===-1?e:m.jsxs(m.Fragment,{children:[e.slice(0,n),m.jsx("mark",{className:"search-highlight",children:e.slice(n,n+t.length)}),e.slice(n+t.length)]})}function lc({topic:e,sectionColor:t,highlight:n,defaultOpen:r=!1}){const[o,l]=Y.useState(r),i=to[e.level]||to[2];return m.jsxs("div",{className:"topic-row",children:[m.jsxs("button",{className:"topic-header",onClick:()=>l(!o),children:[m.jsx("span",{className:"topic-chevron",children:o?"▾":"▸"}),m.jsx("span",{className:"topic-name",children:n?Hl(e.name,n):e.name}),m.jsxs("span",{className:"topic-badges",children:[e.score!=null&&m.jsxs("span",{className:"topic-score",title:"Оценка",children:[e.score,"/5"]}),m.jsxs("span",{className:"topic-level",style:{background:i.color+"22",color:i.color,borderColor:i.color+"44"},children:[e.level," — ",i.label]})]})]}),o&&m.jsx("div",{className:"topic-content",children:m.jsx(ic,{text:e.content})})]})}function ic({text:e}){if(!e)return m.jsx("p",{className:"placeholder",children:"Контент будет добавлен позже"});const t=e.split(`
`),n=[];let r=!1,o=[],l=0;return t.forEach((i,s)=>{if(i.startsWith("```")){r?(n.push(m.jsx("pre",{children:o.join(`
`)},l++)),o=[],r=!1):r=!0;return}if(r){o.push(i);return}if(i.trim()===""){n.push(m.jsx("div",{className:"spacer"},l++));return}let a=i.replace(/\*\*(.+?)\*\*/g,"<strong>$1</strong>").replace(/`([^`]+)`/g,"<code>$1</code>").replace(/^• /,"‣ ");n.push(m.jsx("p",{className:"content-line",dangerouslySetInnerHTML:{__html:a}},l++))}),r&&o.length&&n.push(m.jsx("pre",{children:o.join(`
`)},l++)),m.jsx("div",{className:"formatted-content",children:n})}function Hf({section:e,defaultCollapsed:t=!0,onSelect:n=void 0,collapseKey:r=0}){const[o,l]=Y.useState(t),i=e.topics.length;Y.useEffect(()=>{r>0&&l(!0)},[r]);const s=e.topics.filter(f=>f.score!=null),a=s.length?(s.reduce((f,h)=>f+h.score,0)/s.length).toFixed(1):null;function c(){n?n(e.id):l(!o)}return m.jsxs("div",{className:"section-block",children:[m.jsxs("button",{className:"section-header",onClick:c,style:{"--accent":e.color},children:[m.jsxs("div",{className:"section-left",children:[m.jsx("span",{className:"section-icon",children:e.icon}),m.jsxs("div",{children:[m.jsx("h2",{className:"section-title",children:e.title}),m.jsxs("span",{className:"section-meta",children:[i," тем",a?` · Средняя: ${a}/5`:""]})]})]}),m.jsx("span",{className:"section-chevron",children:o?"▸":"▾"})]}),!o&&m.jsx("div",{className:"section-topics",children:e.topics.map((f,h)=>m.jsx(lc,{topic:f,sectionColor:e.color},h))})]})}function Wf({query:e,sections:t}){const n=e.toLowerCase(),r=[];return t.forEach(o=>{const l=o.topics.filter(i=>i.name.toLowerCase().includes(n)||i.content&&i.content.toLowerCase().includes(n));l.length>0&&r.push({section:o,topics:l})}),r.length===0?m.jsxs("p",{className:"search-empty",children:["Ничего не найдено по запросу «",e,"»"]}):m.jsx(m.Fragment,{children:r.map(({section:o,topics:l})=>m.jsxs("div",{className:"section-block",children:[m.jsx("div",{className:"section-header",style:{"--accent":o.color},children:m.jsxs("div",{className:"section-left",children:[m.jsx("span",{className:"section-icon",children:o.icon}),m.jsxs("div",{children:[m.jsx("h2",{className:"section-title",children:o.title}),m.jsxs("span",{className:"section-meta",children:[l.length," совпадений"]})]})]})}),m.jsx("div",{className:"section-topics",children:l.map((i,s)=>m.jsx(lc,{topic:i,sectionColor:o.color,highlight:e,defaultOpen:!0},s))})]},o.id))})}function Vf({sections:e}){const[t,n]=Y.useState("all"),[r,o]=Y.useState(0),[l,i]=Y.useState(!1),s=[];e.forEach(f=>{f.topics.forEach(h=>{h.content&&(t==="all"||t===f.id)&&s.push({...h,sectionTitle:f.title,sectionIcon:f.icon,sectionColor:f.color})})});const a=s[r];if(!a)return m.jsx("p",{children:"Нет карточек"});const c=to[a.level]||to[2];return m.jsxs("div",{className:"flashcard-mode",children:[m.jsxs("div",{className:"flash-filter",children:[m.jsxs("select",{value:t,onChange:f=>{n(f.target.value),o(0),i(!1)},children:[m.jsx("option",{value:"all",children:"Все разделы"}),e.map(f=>m.jsxs("option",{value:f.id,children:[f.icon," ",f.title]},f.id))]}),m.jsxs("span",{className:"flash-counter",children:[r+1," / ",s.length]})]}),m.jsx("div",{className:`flash-card ${l?"flipped":""}`,onClick:()=>i(!l),children:l?m.jsx("div",{className:"flash-back",children:m.jsx(ic,{text:a.content})}):m.jsxs("div",{className:"flash-front",children:[m.jsxs("span",{className:"flash-section",style:{color:a.sectionColor},children:[a.sectionIcon," ",a.sectionTitle]}),m.jsx("span",{className:"flash-level",style:{color:c.color},children:c.label}),m.jsx("h3",{className:"flash-question",children:a.name}),m.jsx("span",{className:"flash-hint",children:"Нажми, чтобы увидеть ответ"})]})}),m.jsxs("div",{className:"flash-nav",children:[m.jsx("button",{disabled:r===0,onClick:()=>{o(f=>f-1),i(!1)},children:"← Назад"}),m.jsx("button",{onClick:()=>{o(Math.floor(Math.random()*s.length)),i(!1)},children:"🎲 Случайная"}),m.jsx("button",{disabled:r>=s.length-1,onClick:()=>{o(f=>f+1),i(!1)},children:"Далее →"})]})]})}function $s({term:e,highlight:t}){return m.jsxs("div",{className:"term-row",children:[m.jsx("div",{className:"term-name",children:t?Hl(e.name,t):e.name}),e.definition&&m.jsx("div",{className:"term-def",children:t?Hl(e.definition,t):e.definition}),m.jsxs("div",{className:"term-source",children:[m.jsxs("span",{className:"term-section-badge",style:{color:e.sectionColor},children:[e.sectionIcon," ",e.sectionTitle]}),m.jsxs("span",{className:"term-topic",children:["· ",e.topicName]})]})]})}function Bf({sections:e}){const[t,n]=Y.useState(""),[r,o]=Y.useState("all"),l=Uf(e),i=t.trim().toLowerCase(),s=l.filter(f=>{const h=!i||f.name.toLowerCase().includes(i)||f.definition.toLowerCase().includes(i),g=r==="all"||f.sectionId===r;return h&&g}),a=[],c=new Map;return s.forEach(f=>{if(!c.has(f.sectionId)){const h={id:f.sectionId,title:f.sectionTitle,color:f.sectionColor,icon:f.sectionIcon,terms:[]};c.set(f.sectionId,h),a.push(h)}c.get(f.sectionId).terms.push(f)}),m.jsxs("div",{className:"glossary",children:[m.jsxs("div",{className:"glossary-controls",children:[m.jsxs("div",{className:"search-bar",children:[m.jsx("svg",{className:"search-icon",width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:m.jsx("path",{d:"M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.868-3.834zm-5.242 1.156a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"})}),m.jsx("input",{type:"search",placeholder:"Поиск по терминам и определениям...",value:t,onChange:f=>n(f.target.value),className:"search-input"}),t&&m.jsx("button",{className:"search-clear",onClick:()=>n(""),title:"Очистить",children:"✕"})]}),m.jsxs("nav",{className:"section-tabs",style:{marginTop:"10px"},children:[m.jsx("button",{className:`section-tab ${r==="all"?"active":""}`,onClick:()=>o("all"),children:"Все разделы"}),e.map(f=>m.jsxs("button",{className:`section-tab ${r===f.id?"active":""}`,onClick:()=>o(r===f.id?"all":f.id),style:r===f.id?{"--tab-color":f.color}:{},children:[m.jsx("span",{className:"section-tab-icon",children:f.icon}),f.title]},f.id))]})]}),m.jsxs("p",{className:"glossary-stats",children:[s.length," ",s.length===1?"термин":s.length<5?"термина":"терминов"]}),s.length===0?m.jsxs("p",{className:"search-empty",children:["Ничего не найдено по запросу «",t,"»"]}):r!=="all"?m.jsx("div",{className:"glossary-group",children:s.map((f,h)=>m.jsx($s,{term:f,highlight:i},h))}):a.map(f=>m.jsxs("div",{className:"glossary-group",children:[m.jsxs("div",{className:"glossary-group-header",style:{"--accent":f.color},children:[m.jsx("span",{children:f.icon}),m.jsx("span",{children:f.title}),m.jsxs("span",{className:"glossary-count",children:[f.terms.length," терм."]})]}),f.terms.map((h,g)=>m.jsx($s,{term:h,highlight:i},g))]},f.id))]})}function Jf(){const[e,t]=Y.useState("roadmap"),[n,r]=Y.useState("list"),[o,l]=Y.useState(""),[i,s]=Y.useState(!1),[a,c]=Y.useState(null),[f,h]=Y.useState(0),[g,S]=Y.useState(!1),w=Ye.reduce((u,p)=>u+p.topics.length,0),k=e==="roadmap"&&o.trim().length>0,I=a?Ye.filter(u=>u.id===a):Ye;function d(u){t(u),l(""),s(!1),S(!1)}return m.jsxs("div",{className:"app",children:[m.jsxs("div",{className:"mobile-header",children:[m.jsx("button",{className:"burger-btn",onClick:()=>S(u=>!u),"aria-label":"Меню",children:m.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"currentColor",children:[m.jsx("rect",{x:"1",y:"3",width:"16",height:"2",rx:"1"}),m.jsx("rect",{x:"1",y:"8",width:"16",height:"2",rx:"1"}),m.jsx("rect",{x:"1",y:"13",width:"16",height:"2",rx:"1"})]})}),m.jsx("span",{className:"mobile-title",children:"Frontend Senior+"})]}),g&&m.jsx("div",{className:"sidebar-overlay",onClick:()=>S(!1)}),m.jsxs("aside",{className:`sidebar${g?" open":""}`,children:[m.jsxs("div",{className:"sidebar-brand",children:[m.jsx("h1",{className:"app-title",children:"Frontend Senior+"}),m.jsxs("p",{className:"app-sub",children:[Ye.length," разделов · ",w," тем"]})]}),e==="roadmap"&&m.jsxs("div",{className:"sidebar-roadmap-controls",children:[m.jsxs("div",{className:"sidebar-tools-row",children:[m.jsx("button",{className:"view-btn",onClick:()=>h(u=>u+1),title:"Свернуть все",children:m.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[m.jsx("rect",{x:"1",y:"7",width:"14",height:"2",rx:"1"}),m.jsx("path",{d:"M4 5L8 1l4 4",stroke:"currentColor",strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"}),m.jsx("path",{d:"M4 11l4 4 4-4",stroke:"currentColor",strokeWidth:"1.5",fill:"none",strokeLinecap:"round",strokeLinejoin:"round"})]})}),m.jsx("button",{className:`view-btn search-toggle ${i?"active":""}`,onClick:()=>{s(u=>!u),i&&l("")},title:"Поиск",children:m.jsx("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:m.jsx("path",{d:"M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.868-3.834zm-5.242 1.156a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"})})}),m.jsxs("div",{className:"view-toggle",children:[m.jsx("button",{className:`view-btn ${n==="list"?"active":""}`,onClick:()=>r("list"),title:"Список",children:m.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[m.jsx("rect",{x:"1",y:"2",width:"14",height:"2",rx:"1"}),m.jsx("rect",{x:"1",y:"7",width:"14",height:"2",rx:"1"}),m.jsx("rect",{x:"1",y:"12",width:"14",height:"2",rx:"1"})]})}),m.jsx("button",{className:`view-btn ${n==="grid"?"active":""}`,onClick:()=>r("grid"),title:"Сетка",children:m.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:[m.jsx("rect",{x:"1",y:"1",width:"6",height:"6",rx:"1"}),m.jsx("rect",{x:"9",y:"1",width:"6",height:"6",rx:"1"}),m.jsx("rect",{x:"1",y:"9",width:"6",height:"6",rx:"1"}),m.jsx("rect",{x:"9",y:"9",width:"6",height:"6",rx:"1"})]})})]})]}),i&&m.jsxs("div",{className:"search-bar search-bar-expanded",children:[m.jsx("svg",{className:"search-icon",width:"16",height:"16",viewBox:"0 0 16 16",fill:"currentColor",children:m.jsx("path",{d:"M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.868-3.834zm-5.242 1.156a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"})}),m.jsx("input",{type:"search",placeholder:"Поиск...",value:o,onChange:u=>l(u.target.value),className:"search-input",autoFocus:!0,onKeyDown:u=>{u.key==="Escape"&&(l(""),s(!1))}}),o&&m.jsx("button",{className:"search-clear",onClick:()=>l(""),title:"Очистить",children:"✕"})]})]}),m.jsxs("nav",{className:"sidebar-nav",children:[m.jsx("button",{className:`sidebar-tab ${e==="roadmap"?"active":""}`,onClick:()=>d("roadmap"),children:"📋 Темы"}),m.jsx("button",{className:`sidebar-tab ${e==="cards"?"active":""}`,onClick:()=>d("cards"),children:"🃏 Карточки"}),m.jsx("button",{className:`sidebar-tab ${e==="glossary"?"active":""}`,onClick:()=>d("glossary"),children:"📚 Справочник"})]})]}),m.jsxs("div",{className:"app-right",children:[e==="roadmap"&&m.jsx("div",{className:"app-topbar",children:m.jsxs("nav",{className:"section-tabs",children:[m.jsx("button",{className:`section-tab ${a===null?"active":""}`,onClick:()=>c(null),children:"Все"}),Ye.map(u=>m.jsxs("button",{className:`section-tab ${a===u.id?"active":""}`,onClick:()=>c(a===u.id?null:u.id),style:a===u.id?{"--tab-color":u.color}:{},children:[m.jsx("span",{className:"section-tab-icon",children:u.icon}),u.title]},u.id))]})}),m.jsx("main",{className:`app-main ${e==="roadmap"&&!k&&n==="grid"&&!a?"view-grid":""}`,children:e==="roadmap"?k?m.jsx(Wf,{query:o.trim(),sections:I}):I.map(u=>m.jsx(Hf,{section:u,defaultCollapsed:a===null,collapseKey:f,onSelect:n==="grid"&&!a?c:void 0},u.id+(a?"-open":""))):e==="cards"?m.jsx(Vf,{sections:Ye}):m.jsx(Bf,{sections:Ye})},k?`search-${o}`:`${n}-${a}`)]})]})}Qo.createRoot(document.getElementById("root")).render(m.jsx(Tc.StrictMode,{children:m.jsx(Jf,{})}));
